...
# --- Параметры инвестиционной оценки (NPV / IRR / ROI) ---
IMPLEMENTATION_COST = 100_000      # ₽, стоимость разработки и внедрения (оценка)
DISCOUNT_RATE_ANNUAL = 0.145       # ставка дисконтирования = ключевая ставка ЦБ РФ (апр. 2026)
HORIZON_MONTHS = 36                # горизонт оценки, 3 года